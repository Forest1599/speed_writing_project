...
load_dotenv(os.path.join(BASE_DIR, '.env')) # Loads Django environemnt stuff
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'fyp.validators.CustomComplexityPasswordValidator',
    },
]
...
# Maybe will have to change this later
